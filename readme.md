...
- **ICS Calendar Generation**: Automatically generate ICS calendar files for each player's upcoming matches
- **Google Calendar Integration**: One-click addition of player schedules to Google Calendar
...
- **球员排名**：显示当前斯诺克球员排名及详细信息
- **ICS日历生成**：自动为每位球员生成即将到来的比赛的ICS日历文件
- **Google Calendar集成**：一键将球员赛程添加到Google Calendar
- **多语言支持**：英语、中文
- **自动数据更新**：每日自动更新数据
